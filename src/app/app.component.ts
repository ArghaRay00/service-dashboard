...
export class ExampleDataSource extends DataSource<ServiceRequest> {
  ...
  connect(): Observable<ServiceRequest[]> {
  ...
  sortData(data: ServiceRequest[]): ServiceRequest[] {
